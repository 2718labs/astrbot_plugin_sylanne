...
class NativeV2FFITests(unittest.TestCase):
    ...
    def test_python_layout_keeps_linear_step_diagnostic_without_struct_change(self) -> None:
        ...
        self.assertGreaterEqual(result.iteration_error, 0.0)
        self.assertGreaterEqual(result.trajectory_error, result.iteration_error)
